            ...
            <div class="col-md-12">
                ...
                <div class="box box-widget">
                    <div class="box-header with-border">
                        ...
                        @if ($subCategory->avatar !== NULL)
                        <div class="user-profile" style="text-align: center">
                            <img src=" {{ Storage::disk('public')->url('users/'.$subCategory->avatar) }} " alt="">
                        </div>
                        @endif
                        <h3 style="text-align: center" >{{ $subCategory->sub_category_name }}</h3>
                        </div>
                        <!-- /.user-block -->
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <table id="showProfileTable" class="table table-bordered table-striped">
                            ...
                            <tr>
                                <td>Action: </td>
                                <td> 
                                    <a href=" {{ route('admin.sub_category.edit',$subCategory->id) }} "><button class="btn btn-warning flat-btn"><i class="fa fa-edit"></i></button></a>    
                                </td>
                            </tr>
                        </table>
                    <!-- /.box-body -->
