            ...
            <div class="box-body">
                ...
                <form role="form" action="{{ route('user.email.send') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12 col-lg-6">
                                <input type="text" class="form-control" name="name" placeholder="name" hidden value="{{ Auth::user()->name }}">
                            </div>
                            <div class="col-sm-12 col-lg-6">
                    ...
                    <div class="btn-toolbar form-group mb-0">
                        <div class="">
                            <button class="btn btn-success flat-btn" type="submit"> <span>Send</span> <i class="fa fa-rocket"></i> </button>
                        </div>
                    </div>
